...
class MetaRaw(SimpleNamespace):
    ...
    @classmethod
    def set_numeric_feature_names(cls, value):
        cls.numeric_feature_names = value

    @classmethod
    def set_feature_names(cls, value):
        cls.feature_defaults = value
        cls.csv_column_names = cls.feature_names + [cls.target]
        cls.numeric_feature_names = cls.feature_names

    @classmethod
    def set_target(cls, value):
        cls.target = value
        cls.csv_column_names = cls.feature_names + [cls.target]

    @classmethod
    def set_categorical_feature_names(cls, value):
        cls.categorical_feature_names = value
    ...
    @classmethod
    def set_csv_column_names(cls, value):
        cls.csv_column_names = value

    @classmethod
    def set_feature_defaults(cls, value):
        cls.feature_defaults = value

    @classmethod
    def set_csv_column_defaults(cls, value):
        cls.csv_column_defaults = value
...
class MetaETL(SimpleNamespace):
    ...
    def get_feature_names(cls):
        return MetaRaw.feature_names

    @classmethod
    def get_numeric_feature_names(cls):
        return cls.get_feature_names()

    @classmethod
    def get_target(cls):
        return MetaRaw.target
...
def get_feature_columns()->Dict[str, Any]:
    numeric_columns = {feature_name: tf.feature_column.numeric_column(feature_name)
                       for feature_name in MetaETL.get_numeric_feature_names()}
    feature_columns = {}
