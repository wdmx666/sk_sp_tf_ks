...
from my_tf.estimator_tpl.iris_premade import get_feature_columns, MetaRaw,csv_input_fn,maybe_download
...
def main(argv):
    from my_tf.estimator_tpl.iris_premade import run_experiment
